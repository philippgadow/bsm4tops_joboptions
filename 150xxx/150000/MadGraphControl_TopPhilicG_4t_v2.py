...
#---------------------------------------------------------------------------------------------------                                               
# Add reweight card, allowing for scans of theta1 and ct1
#---------------------------------------------------------------------------------------------------                
...
for i_ct1, i_theta1 in product(ct1_scan, theta1_scan):
  reweightCommand += "launch --rwgt_name=rwgt_ct1_{ct1_str}_theta1_{theta1_str}\nset v0params 1 {ct1}\nset v1params 1 {theta1}\n\n".format(
    ct1=i_ct1, ct1_str=str(i_ct1).replace('.', 'p'), theta1=i_theta1, theta1_str="{0:.2f}".format(i_theta1).replace('.', 'p')
  )
